...
<body>
	<div class="container">
		<div id="headdiv"></div>
		<div style="width:80%;height:200px;padding: 20px;display: flex;background-color: aliceblue;">
			<div style="width:20%;height:100px;background-color: aquamarine;">
			</div>
			<div style="width:60%;position: left;height:100px;background-color: bisque;">
			</div>
		</div>
		<div id="footdiv"></div>
	</div>
